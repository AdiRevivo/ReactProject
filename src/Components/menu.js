                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                                ...
                                <li class="nav-item">
                                    <Link class="nav-link" to={'/shopProduct'}>דף קניה</Link>
                                </li>
                            </ul>
                        </div>
                            ...
                            <!-- Grid column --> */}
                                <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
                                    ...
                                    <h6 class="text-uppercase fw-bold mb-4">
                                        קישורים שימושים                                    </h6>
                                    <p>
                                        <a href="http://localhost:3000/" class="text-reset">בית</a>
                                    </p>
                                    <p>
                                        <a href="http://localhost:3000/contactUs" class="text-reset">צור קשר</a>
                                    </p>
                                    <p>
                                        <a href="http://localhost:3000/aboutUs" class="text-reset">מי- אנחנו</a>
                                    </p>
                                    {/* <p>
